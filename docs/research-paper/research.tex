...
\begin{document}
	...
	\begin{hoofdstuk}{Introduction}
		...
		A company of this caliber is sure to bring attention and support for the FPGA market.
...
%							\node[anchor=north] at (0.1,-0.13) {{\footnotesize$\rho$}};
		...
		\begin{paragraaf}{The Final Chosen Pipeline}
			...
			As I mentioned in \verwijzingn{subsubparagraaf}{Time and Space Complexity}, I will not be able to use the DSP slices because the FPGA development board manufacturer has no documentation on them.
