...
\begin{document}
	...
	\maketitlepage{Technical Design}{1.0}
	...
	\begin{hoofdstuk}{System Overview}
		...
		\begin{paragraaf}{Component Definition}
			...
			\begin{figuur}{SysML Block Definition Diagram}
				...
				\vspace{1.5ex}
				(please see \textit{Appendix}\verwijzingn{paragraaf}{SysML Block Definition Diagram}for a magnified version)
				\onehalfspacing
			\end{figuur}
	...
	\begin{hoofdstuk}{Software Layer}
		...
		\begin{paragraaf}{Serial Interface}
			...
			This blocking call is indicated in \verwijzingb{figuur}{Serial Connection Sequence Diagram} in red color.
