...
\begin{document}
	...
	\begin{inhoudspagina}
		...
		\begin{table}[!ht]
			\begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} R}
				...
				MPSoC & Multi-Processor SoC; a SoC with multiple physical cores in the processor \tabularnewline
	...
	\begin{hoofdstuk}{Hardware Layer}
		...
		\begin{paragraaf}{Memory Layout}
			...
			The alternatives places to store an image are the 16 MiB of Quad-SPI flash or the 256 MB DDR3 SDRAM.
			...
			The DDR3 SDRAM has one major downside: it requires the use of the proprietary Xilinx Memor Interface Generator (MIG) which Digilent does not provide any support for.
			...
			I reevaluated the choice and started looking at other development boards.
			...
			In the PL, this SDRAM can be accessed using a VDMA controller which provides data over AXI Streams.
			These AXI Streams can be connected to those on the the Vitis Vision HLS-generated RTL solution.
			...
			My final decision is to use the DDR3 SDRAM because it is plentyful on the Z2 board; all 512 MB can be used by the user.
