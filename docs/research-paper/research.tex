...
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
	...
	\Subject{Research into lane detection algorithmes}
	\Author{Matthijs Bakker}
	\Language{en-US}
	\Keywords{research\sep paper}
\end{filecontents*}
...
\begin{document}
	...
	% Cover page
	\maketitlepage{Research into Lane Detection Algorithms for FPGAs}{0.1}
...
%			A selection process will occur, in which the candidate algorithms will be judged by the following metrics:
	...
	\begin{hoofdstuk}{Results}
		...
		\begin{paragraaf}{Application of Techniques}
			...
			Next up, I wrote a computer program which implemented the most used processing steps from \verwijzingn{paragraaf}{Listing of Candidate Algorithms}.
			...
			\begin{subparagraaf}{$k$-means Image Segmentation Implementation}
				...
				When applying the Gaussian and Sobel steps as noted in \verwijzingn{subparagraaf}{Filter Development}, I still noticed a lot of noise in the Sobel output.
...
%							\node[anchor=north] at (0.1,-0.13) {{\footnotesize$\rho$}};
		...
		\begin{paragraaf}{The Final Chosen Pipeline}
			...
			As I mentioned in \verwijzingn{subsubparagraaf}{Time and Space Complexities}, I will not be able to use the DSP slices because the FPGA development board manufacturer has no documentation on them.
