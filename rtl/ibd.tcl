...
com.arobs:lane_detection:vpu_accel:0.1\
...
proc create_root_design { parentCell } {
  ...
  set resize_accel_0 [ create_bd_cell -type ip -vlnv com.arobs:lane_detection:vpu_accel:0.1 resize_accel_0 ]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS] [get_bd_intf_pins resize_accel_0/in_r]
  ...
  connect_bd_intf_net -intf_net resize_accel_0_dst [get_bd_intf_pins axis_dwidth_converter_1/S_AXIS] [get_bd_intf_pins resize_accel_0/out_r]
  ...
  # Hook up the memory and fixed io ports to the PS
