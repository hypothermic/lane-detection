		...
		\begin{paragraaf}{The Organization}
			...
			\begin{figuur}{Organogram of AROBS Group}
				...
				\begin{tikzpicture}
					...
					\node (org label) [below right=0.8em and 0.8em of org.north west, align=left] {AROBS Group};
					...
					\node (rom label) [below right=0.8em and 0.8em of rom.north west, align=left] {AROBS Transilvania SA};
					...
					\node (oth label) [below=0.8em of oth.north, align=center] {Intl. Units};
					...
					\node (aum label) [below right=0.8em and 0.8em of aum.north west, align=left] {Automotive Dept.};
					...
					\node (emb label) [below right=0.8em and 0.8em of emb.north west, align=left] {Embedded Sector};
			...
			Other weeks were mostly spent on documentation and it was not worth holding meetings because I would not have much news to show.
