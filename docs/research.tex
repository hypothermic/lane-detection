...
\begin{document}
	...
	\begin{hoofdstuk}{Literature Study}
		...
		\begin{paragraaf}{Line Classification Techniques}
			...
			\begin{subparagraaf}{\texorpdfstring{$k$}{k}-means Clustering of HT Results }
	...
	\begin{hoofdstuk}{Results}
		...
		\begin{paragraaf}{Application of Techniques}
			...
			\begin{subparagraaf}{Hough Transform Implementation}
				...
				However, due to it being simpler and more efficient, I chose to implement the line classification using a kernel-based approach.
