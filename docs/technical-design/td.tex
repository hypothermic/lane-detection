...
\begin{document}
	...
	\begin{hoofdstuk}{System Overview}
		...
		\begin{paragraaf}{Implementation Strategy}
			...
			The processor comes pre-programmed with an embedded Linux distribution that has the PYNQ software running on it.
			This PYNQ software consists of an FPGA programming framework and a Jupyter webserver.
